...
*  functions for unit testing functions among those 3 classes above and main().
*
*  Deanna Oei 
*  October 6, 2020 
*/  
...
// void checkNumArgs(int argc)
// {
//     string USAGE = "Usage: ./MetroSim stationsFile outputFile [commandsFile]";
//     if (argc < 3 or argc > 4) { //if no station file or more than needed, abort
// 		abort(USAGE);
// 	}
// }
